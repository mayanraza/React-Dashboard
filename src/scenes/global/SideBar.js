...
// import { HomeModeOutlined } from '@mui/icons-material';
            ...
            <ProSidebar collapsed={isCollapsed}>
                <Menu iconShape="square">
                    ...
                    {!isCollapsed && (
                        ...
                        <Box mb="25px">
                            ...
                            <Box textAlign="center">
                                <Typography variant="h2" color={colors.grey[100]} fontWeight="bold" sx={{ m: "10px 0 0 0" }} >Ayan</Typography>
                    ...
                    <Box paddingLeft={isCollapsed ? undefined : "10%"}>
                        ...
                        <Typography variant="h6" colors={colors.grey[300]} sx={{ m: "15px 0 5px 20px" }}>Data</Typography>
                        ...
                        <Typography variant="h6" colors={colors.grey[300]} sx={{ m: "15px 0 5px 20px" }}>Pages</Typography>
                        ...
                        <Typography variant="h6" colors={colors.grey[300]} sx={{ m: "15px 0 5px 20px" }}>Charts</Typography>
